...
Login.prototype.refresh = function(sessionId) {
		   ...
		   console.log('previous session id ' + sessionId + '  for login :: ' +oldemail);
		   var newsessionId = new Date().getTime();
		   this.sessionMap[newsessionId] = { name : oldname , email : oldemail};
		   console.log('new session id ' + newsessionId + '  for login :: ' +oldemail);
		   delete this.sessionMap[sessionId];
		   };
